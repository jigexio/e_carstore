...
import com.jigexio.store.service.imp.CustomerServiceImp;
import com.jigexio.store.service.imp.GoodsServiceImp;
import com.jigexio.store.service.imp.OrdersServiceImp;
    ...
    protected void doGet(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws javax.servlet.ServletException, IOException {
        ...
        if ("reg".equals(action)) {
            ...
            if (page.equals("prev")) { //上一页
                currentPage--;
                if (currentPage < 1) {
                    currentPage = 1; //如果当前页数小于时1，则令当前页数为1
                }
            } else if (page.equals("next")) {// 下一页
                currentPage++;
                if (currentPage > totalPageNumber) {
                    currentPage = totalPageNumber; //如果当前页数大于总页数时，则令当前页数=总页数
                }
            } else {
